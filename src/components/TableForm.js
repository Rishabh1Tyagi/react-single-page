            ...
            return (
              <div class="card" key={index}>
                ...
                <table>
                  ...
                  <td> 
                    <input type="radio" id="html" value="Several times/week" /> {" "}
                    <label for="html">Several times/week</label>
                  </td>
                  <td> 
                      <input type="radio" id="html" value="A few times/week" /> {" "}
                ...
                <div>
                <table>
                  <th class="inner_texts">
                    When do you experience the problems?
                  </th>
                ...
                <div class="buttons">
                  ...
                  <button class="inner_button" onClick={addFields}>
                    Next
                  </button>
                </div>
                {/* ends here  */}
